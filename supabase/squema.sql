-- =============================================================================
-- Schema: Plataforma de Democracia Participativa
-- Versão: 1.0
-- Descrição: Estrutura inicial para coletar e organizar propostas da população.
-- =============================================================================
...
-- Insere as RAs do DF (se a tabela estiver vazia)
...
CREATE TABLE IF NOT EXISTS public."Proposals" (
  ...
  status text NOT NULL DEFAULT 'recebida' -- Ex: recebida, em_analise, aprovada
);


-- =============================================================================
-- SEÇÃO 2: POLÍTICAS DE SEGURANÇA (RLS)
-- =============================================================================
